...
// Para enviar códigos de resposta do HTTP usamos a função header()
...
// Alterar o tipo de resposta e setar charset
header('Content-Type: text/plain;charset=utf-8'); // Texto puro
