...
window.onload = function() {
    ...
    frm.onsubmit = frm1Submit;
    
    var pfcpf = document.getElementById('pfcpf');
    pfcpf.oninput = oninputCpfElemento;
}

function frm1Submit(e) {
    window.alert('Enviando formulário');
}

function oninputCpfElemento() {
...
/**
 * @link http://tableless.com.br/html5/?chapter=8
 */
